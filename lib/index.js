        ...
        return regenerator_default().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              width = Math.min(img.width / scaleRatio, window.innerWidth);
              height = Math.min(img.height / scaleRatio, width / img.width * img.height);
